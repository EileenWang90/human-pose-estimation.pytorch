...
def get_model_name(cfg):
    ...
    if name in ['pose_resnet', 'pose_shufflenetv2', 'pose_shufflenetv2_short', 'pose_mobilenet', 'pose_mobilenet_8', 'pose_mobilenet_relu', 'pose_mobilenet_allrelu', 'pose_mobilenet_relu_bnfuse',  'pose_mobilenet_relu_bnfuse_deconv3']:
